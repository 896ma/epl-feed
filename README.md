...
After successfully running the script, you will notice t ayour feed  is visible from within the app, as well as share it by embedding a link in a post (similar to a quote post).
